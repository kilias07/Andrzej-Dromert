...
const Contact = () => {
  ...
  return (
    <>
      <Head>
        <title>Andrzej Dromert - Kontakt</title>
        <meta property={'og:title'} content="kontakt" />
      </Head>
      <motion.div
        className="heightAdjustScreen mx-auto flex w-5/6 flex-wrap items-center justify-center py-10"
        exit={{ opacity: 0 }}
        initial={{ opacity: 0 }}
        transition={{ duration: 0.5 }}
        animate={{ opacity: 1 }}
      >
        <div className="flex content-center justify-center lg:px-24">
          <h1 className="text-xl">Skontaktuj się ze mną</h1>
        </div>
        <form className="lg:px-24" onSubmit={handleSubmit(onSubmit)}>
